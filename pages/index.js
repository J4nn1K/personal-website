...
export default function Home() {
  return (
    <div>
      ...
      <div className="bg-white dark:bg-zinc-900 h-screen p-4 min-h-screen flex flex-col">
        ...
        <div className="flex flex-1 text-center items-center justify-center">
          <div className="flex flex-col items-center">
            <h1 className="text-zinc-900 dark:text-white text-5xl font-black">Jannik Jorge Grothusen</h1>
            <p className="py-4 text-zinc-500 dark:text-zinc-400 text-xl font-normal">Making what I want since 2000.</p>
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/jannikjorgegrothusen/" className="text-zinc-900 dark:text-white">
              ...
              <a href="https://github.com/J4nn1K/" className="text-zinc-900 dark:text-white">
      ...
      {/* <footer class="footer footer-center p-4 bg-base-300 text-base-content">
        <div>
          <p>Copyright © 2022 - All right reserved by Jannik Jorge Grothusen.</p>
        </div>
      </footer> */}
    </div>
  )
