          ...
          <div className="flex flex-1 text-center items-center justify-center">
            <div className="flex flex-col items-center">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/jannikjorgegrothusen/" target="_blank" className="text-zinc-900 dark:text-white">
                ...
                <a href="https://github.com/J4nn1K/" target="_blank" className="text-zinc-900 dark:text-white">
